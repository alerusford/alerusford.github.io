    ...
    var o = n(57),
        ...
        s = function() {
            ...
            e.initialize = function() {
                ...
                return t[e]
            }, e.initWidget = function(t, o, i) {
                var r = e.app(o.app);
                if (r) {
                    if (s.indexOf(t) !== -1) return;
                    s.push(t), r.initWidget(t, o), e.sendExtensionPostMessage(t, o, i)
                } else n.push({
                    element: t,
                    config: o,
                    initialized: !1
            ...
            n.initialize = function() {
                ...
                if (o) {
                    ...
                    var a = {
                        ...
                        deactivate: 1 === r.preferences.disable_widget, /*была единица - тогда виджет белый и ссылка на сайт*/
                        widgetId: r.id || null,
                        widgetOrigin: "apps.elfsight.com",
                        hideElfsightLogo: !r.preferences.hide_elfsight_logo,
                        owner: r.isOwner,
                        platform: r.platform
                    };
