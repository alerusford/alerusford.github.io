<?php
class ControllerExtensionModuleXtensionsCheckoutXBasicCaptcha extends Controller {
	public function index() {
		...
		return $this->load->view($this->config->get('xtensions_view_path').'xbasic_captcha', $data);
	}
	...
	public function captcha() {
		...
		$this->session->data['captcha'] = $image_number;
