            ...
            <div class="col-sm-10">
              ...
              <div class="input-group">
                ...
                <textarea name="sbrf_online_bank[<?php echo $language['language_id']; ?>]" rows="10"
                          id="input-sbrf_online_bank<?php echo $language['language_id']; ?>" class="form-control summernote" data-lang="<?php echo $lang; ?>"
            ...
            <div class="col-sm-10">
              <div class="input-group">
                ...
                <textarea name="sbrf_online_page_success[<?php echo $language['language_id']; ?>]" rows="10"
                          id="input-sbrf_online_page_success<?php echo $language['language_id']; ?>" class="form-control summernote" data-lang="<?php echo $lang; ?>"
...
<script type="text/javascript"><!--
  <?php if ($ckeditor) { ?>
    <?php foreach ($languages as $language) { ?>
      ckeditorInit('input-sbrf_online_bank', getURLVar('token'));
      ckeditorInit('input-sbrf_online_page_success', getURLVar('token'));
    <?php } ?>
  <?php } ?>
//--></script>
<?php echo $footer; ?>