...
<div id="content">
  <div class="container-fluid"><br />
    ...
    <div class="row">
      ...
      <link rel="stylesheet" href="../admin/view/stylesheet/login.css">
...
<body>
  ...
  <svg width="200px" height="200px" viewBox="0 0 200 200" aria-labelledby="svg-title svg-desc">
    ...
    <g id="ghost-body" fill="white" fill="#fff" stroke="#337ab7" stroke-width="3" stroke-linejoin="round">
      ...
      <path id="mouth" d="M 75,115 C 79,120 91,126 101,125 110,125 126,118 127,114 125,117 117,125 101,125 85,126 79,117 75,115 Z" fill="#fff" stroke="#f22929" />
  ...
  <fieldset id="email-field" class="with-placeholder">
   <!-- <legend>Логин</legend> -->
    <div>
      <input type="text" name="username" id="email"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required value="<?php echo $username; ?>" placeholder="<?php echo $entry_username; ?>" id="input-username" class="form-control" />
  ...
  <fieldset id="password-field">
    <legend></legend>
    <div>
      <input type="password" name="password" id="password"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required value="<?php echo $password; ?>" placeholder="<?php echo $entry_password; ?>" id="input-password" class="form-control" />
    </div>
  </fieldset>
  <fieldset id="submit-field">
    <!--  <legend></legend> -->
    <div>
      <input type="submit" name="submit" id="submit" value="Войти" <?php echo $button_login; ?>/>
    </div>
  </fieldset>
</form>
    ...
    <script  src="../admin/view/javascript/login.js"></script>
