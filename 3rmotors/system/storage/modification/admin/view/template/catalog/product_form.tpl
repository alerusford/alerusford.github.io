          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
				...
				<h3>Фото для <?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?></h3>
				<div>
				...
				<div style="display:inline-block;margin-left:20px;">
					<button type="button" data-toggle="tooltip" title="Выбрать напрямую" class="addeasyphoto btn btn-primary"><i class="fa fa-plus-circle"></i> Выбор</button>
				</div>
				</div>	  
				<style>
				...
				#photos{margin-top:20px;display:inline-block;vertical-align:top;}
