...
<link href="/admin/view/image/favicon_admin.ico" rel="icon" />
...
<?php } ?>
  ...
  <ul class="nav pull-right">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><?php if($alerts > 0) { ?><span class="label label-danger pull-left"><?php echo $processing_status_total; ?><?php //echo $alerts;  ?></span><?php } ?> <i class="fa fa-bell fa-lg"></i></a>
