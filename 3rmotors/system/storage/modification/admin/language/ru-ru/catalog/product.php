...
$_['entry_ean']              = 'EAN';
$_['entry_jan']              = 
				'<div style=background:#de6767;width:40px;height:17px;position:absolute;right:1px;></div>'
			;
$_['entry_isbn']             = 
				'<div style=background:#8bad49;width:40px;height:17px;position:absolute;right:1px;></div>'
			;
$_['entry_mpn']              = 
				'<div style=background:#ba86ae;width:40px;height:17px;position:absolute;right:1px;></div>'
			;
