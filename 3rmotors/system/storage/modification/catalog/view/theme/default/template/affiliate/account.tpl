...
<div class="col-md-3 text-center"><div class="product-thumb"><a href="<?php echo $payment; ?>"><img src="catalog/view/theme/default/image/account-images/payment.png" alt="<?php echo $text_payment; ?>" >
...
<div class="col-md-3 text-center"><div class="product-thumb"><a href="<?php echo $tracking; ?>"><img src="catalog/view/theme/default/image/account-images/tracking.png" alt="<?php echo $text_tracking; ?>" >
