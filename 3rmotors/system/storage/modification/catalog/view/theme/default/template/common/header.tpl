...
.label-product:nth-child(3) {
	top: 74px;
        ...
        <script src="catalog/view/javascript/ocdev_smart_cart/jquery.magnific-popup.min.js?v=<?php echo $smca_form_data['front_module_version']; ?>" type="text/javascript"></script>
        <link href="catalog/view/javascript/ocdev_smart_cart/magnific-popup.css?v=<?php echo $smca_form_data['front_module_version']; ?>" rel="stylesheet" media="screen" />
        <link rel="stylesheet" type="text/css" href="catalog/view/theme/default/stylesheet/ocdev_smart_cart/stylesheet.css?v=<?php echo $smca_form_data['front_module_version']; ?>"/>
        <script type="text/javascript" src="catalog/view/javascript/ocdev_smart_cart/ocdev_smart_cart.js?v=<?php echo $smca_form_data['front_module_version']; ?>"></script>
        <!-- <?php echo $smca_form_data['front_module_name'].':'.$smca_form_data['front_module_version']; ?> -->
        <?php } ?>
