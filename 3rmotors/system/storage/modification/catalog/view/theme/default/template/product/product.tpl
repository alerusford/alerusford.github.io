...
/*атрибуты, могут пригтиться для вывода срока поставки*/
...
<td><?php echo $attribute['text']; ?></td>
        ...
        <?php $class = 'col-sm-6'; ?>
        <?php } else { ?>
        <?php $class = 'col-sm-4 text-center'; ?>
        <?php } ?>
        <div class="<?php echo $class; ?>">
          <div class="btn-group">
          ...
          <div id="product">
              ...
              <div id="input-option<?php echo $option['product_option_id']; ?>">
                ...
                <div class="radio">
                  <label>
                    ...
                    <img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . strip_tags($option_value['price']) : ''); ?>" class="img-thumbnail" /> 
                    <?php } ?>                    
			...
			<h4><?php echo $text_view; ?><?php echo $view; ?></h4>
          ...
          <div class="rating">
            <p>
             ...
             <!--  <span class="fa fa-stack"><i class="fa fa-star-o fa-stack-1x"></i></span> -->
              <span class="fa fa-stack"><i class="far fa-star fa-star-1x"></i></span>
              <?php } else { ?>
              <!-- <span class="fa fa-stack"><i class="fa fa-star fa-stack-1x"></i><i class="fa fa-star-o fa-stack-1x"></i></span> -->
              <span class="fa fa-stack"><i class="fas fa-star fa-star-1x"></i><!-- <i class="far fa-star fa-star-1x"></i> --></span>
              <?php } ?>
              <?php } ?>
