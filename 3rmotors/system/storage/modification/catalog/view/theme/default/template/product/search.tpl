...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <input type="button" value="<?php echo $button_search; ?>" id="button-search" class="btn btn-primary" style="width:100%" />
      ...
      <div class="row">
        <div class="col-md-2 col-sm-6 hidden-xs">
          <div class="btn-group btn-group-sm">
			...
			<button type="button" id="list-view-new" class="btn btn-default" data-toggle="tooltip" title="<?php echo $button_list; ?>"><i class="fas fa-th-list"></i></button>
			
            <button type="button" id="grid-view-new" class="btn btn-default" data-toggle="tooltip" title="<?php echo $button_grid; ?>"><i class="fas fa-th"></i></button>
			<button type="button" id="price-view" class="btn btn-default" data-toggle="tooltip" title="<?php echo $button_price; ?>"><i class="fas fa-align-justify"></i></button>
...
<div class="stock_status text-left">
<?php
...
<?php //} ?> -->
              ...
              <div class="button-group">
                <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i></i><!-- <i class="fa fa-shopping-cart"></i><img src="/image/catalog/korzina.png" alt="Добавить в корзину"> --><span class="hidden-xs hidden-sm hidden-md"><?php //echo $button_cart; ?></span></button>
