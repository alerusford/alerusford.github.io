...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['text_newsletter'] = $this->language->get('text_newsletter');
				...
				// Mistake
				$this->load->model('setting/setting');			
				$data['mistake_admin_email'] = $this->config->get('config_email');				
				
				$this->load->language('module/mistake');
				$data['mistake_send'] = $this->language->get('mistake_send');
				$data['mistake_comment'] = $this->language->get('mistake_comment');
				$data['mistake_title'] = $this->language->get('mistake_title');
				$data['mistake_success'] = $this->language->get('mistake_success');
				$data['mistake_main_text'] = $this->language->get('mistake_main_text');
				// Mistake End
