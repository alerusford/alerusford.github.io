		...
		<?php if (	(isset ($settings_blog['view_date']) && $settings_blog['view_date'])
			...
			<div class="blog-small-record">
				<ul>
					...
					<li class="blog-comments-record"><?php echo $tab_comment; ?>:<ins style="text-decoration:none;" class="comment_count"><?php echo $comment_count; ?></ins></li>
					<?php } ?>
...
<script>
$(document).ready(function() {
	if (typeof $('.owl-carousel').data('owlCarousel') !== 'undefined' {
		 $('.owl-carousel').data('owlCarousel').onResize();
	}
});
</script>
<?php echo $footer; ?>