...
<div id="content"><?php echo $content_top; ?>
	<?php if (SC_VERSION >= 20) { ?>
		<ul class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
		    ...
		    <li typeof="v:Breadcrumb"><?php if ($count_breadcrumbs != $i) { ?><a href="<?php echo $breadcrumb['href']; ?>" rel="v:url" property="v:title"><?php } else { ?><a href="<?php echo $breadcrumb['href']; ?>#" rel="v:url" property="v:title"><?php } ?><?php echo $breadcrumb['text']; ?></a></li>
		    <?php } ?>
		</ul>
	<?php } else { ?>
		<div class="breadcrumb">
			...
			<?php echo $breadcrumb['separator']; ?><?php if ($count_breadcrumbs!= $i) { ?><a href="<?php echo $breadcrumb['href']; ?>" rel="v:url" property="v:title"><?php } else { ?><a href="<?php echo $breadcrumb['href']; ?>#" rel="v:url" property="v:title"><?php } ?><?php echo $breadcrumb['text']; ?></a>
			</span>
			<?php } ?>
			</span>
		</div>
