...
function getPluginName ($section)
{
    switch ($section) {
        ...
        case 'profile':
            ...
            break;
        case 'pm':
            return T_('Личные сообщения').getPMCount();
            break;
        case 'recipes':
            return T_('Семейные рецепты');
            break;
        case 'settings':
            return T_('Настройки');
            break;
        case 'tree':
            return T_('Семейное древо');
            break;
        case 'videogallery':
            return T_('Видео галерея');
            break;
