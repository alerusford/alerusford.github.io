...
{
    $day_initial[0] = T_pgettext('One letter abbreviation for Sunday.', 'ВС');
    $day_initial[1] = T_pgettext('One letter abbreviation for Monday.', 'ПН');
    $day_initial[2] = T_pgettext('One letter abbreviation for Tuesday.', 'ВТ');
    $day_initial[3] = T_pgettext('One letter abbreviation for Wednesday.', 'СР');
    $day_initial[4] = T_pgettext('One letter abbreviation for Thursday.', 'ЧТ');
    $day_initial[5] = T_pgettext('One letter abbreviation for Friday.', 'ПТ');
    $day_initial[6] = T_pgettext('One letter abbreviation for Saturday.', 'СБ');
