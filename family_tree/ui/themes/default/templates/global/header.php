...
<body id="top">
    ...
    <div id="header">
        ...
        <p>
            <?php echo T_('Добро пожаловать, '); ?> <a href="<?php echo $TMPL['path'] . "profile.php"; ?>"><?php echo $TMPL['displayname']; ?></a> <?php displayNewPM($TMPL['currentUserId'], $TMPL['path']); ?> | 
            <a href="<?php echo $TMPL['path'] . "settings.php";?>"><?php echo T_('Мои настройки'); ?></a> | 
            <a href="<?php echo $TMPL['path'] . "logout.php"; ?>"><?php echo T_('Выход'); ?></a>
        </p>
    </div>
