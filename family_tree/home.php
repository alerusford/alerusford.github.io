...
class Page
{
    ...
    function displayHeader ()
    {
        $params = array(
            ...
            'pagetitle'     => T_pgettext('The beginning or starting place.', 'Главная'),
            'pageId'        => 'home',
            'path'          => URL_PREFIX,
    ...
    function displayLeftColumn ()
    {
        ...
        $templateParams = array(
            'textCalendar'      => T_('Календарь'),
            'textUpcoming'      => T_('Следующий'),
            'textMembersOnline' => T_('Семья Онлайн'),
        );
    ...
    function displayWhatsNew ()
    {
        ...
        // Template params
        $templateParams = array(
            'textSharePlaceholder'  => T_('Общее'),
            'textShareTitle'        => T_('Share something with everyone'),
            'textSubmit'            => T_('Отправить'),
        );
